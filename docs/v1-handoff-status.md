...
- **Jetson environment setup hardening**: document or smooth the Jetson install path where an existing conda environment plus `PYTHONPATH` was used for source-snapshot validation.
