...
- **Jetson sampled comparison rehearsal**: capture two sampled Jetson runs with the same protocol and verify `report compare` remains protocol-first while sampler evidence stays supplemental.
