...
- `docs/ko/runtime-regression-monitor.md` — Runtime regression monitor의 comparability-first 역할 경계를 한국어로 빠르게 확인하는 guide
...
- `docs/release-follow-up-v0.1.5.md` — `v0.1.5` v1-complete release baseline 이후 사용자가 무엇을 믿고 어디서 시작할지 정리한 짧은 follow-up note
...
- `docs/portfolio_summary.md` — InferEdgeEnv 단독 레포 기준 30초 포트폴리오 요약, 역할 경계, reviewer path
...
- `docs/v0.1.4-bilingual-docs-sanity-sweep.md` — README, 한국어 README, 영어 대표 문서 경로를 새 사용자 관점으로 점검한 기록
- `docs/v0.1.3-post-release-sanity-sweep.md` — `v0.1.3` tag/GitHub Release 이후 README/release note의 첫 진입 문구를 점검한 기록
- `docs/v0.1.3-user-feedback-backlog.md` — 현재 README 시작 경로에서 다음 후보 릴리스로 묶을 작은 first-user 사용성 마찰을 수집하는 기준
- `docs/v0.1.3-feedback-template-rehearsal.md` — README Quickstart를 새 사용자 관점으로 재현하고 feedback issue template 샘플을 점검한 기록
- `docs/v0.1.3-synthetic-user-simulation.md` — 실제 외부 사용자가 없을 때 역할별 README 시작 경로를 시뮬레이션하고 작은 문구 drift를 찾은 기록
...
- `docs/v0.1.5-release-rehearsal.md` — clean-room source archive 기준 v0.1.5 patch 후보 release gate와 후보 판단 기록
- `docs/v0.1.4-release-rehearsal.md` — release quality gate 기준으로 `v0.1.4` 후보 smoke를 실제 수행한 기록
